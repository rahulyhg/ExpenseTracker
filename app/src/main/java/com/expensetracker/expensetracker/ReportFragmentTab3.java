 ...
 */
public class ReportFragmentTab3 extends Fragment {

    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private static final String TAG = "FragmentReportTab3";
    ...
    public static ReportFragmentTab3 newInstance(String param1, String param2) {
        ReportFragmentTab3 fragment = new ReportFragmentTab3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_report_extra, null);
