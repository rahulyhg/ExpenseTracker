...
//    private TextView tvX, tvY;
    ...
    public void onStart() {
        super.onStart();
        mListener.onFragmentInteraction("Expense Tracker");
        Log.e(TAG, "OnStart");
    }
...
/*      tvX = (TextView) root.findViewById(R.id.tvXMax);
        ...
        mChart = (PieChart) root.findViewById(R.id.chart1);
    ...
    private void setData(int count, float range) {
        ...
        PieDataSet dataSet = new PieDataSet(yVals1, "Expense Tracker");
...
/*
    ...
    private SpannableString generateCenterSpannableText() {
        ...
        SpannableString s = new SpannableString("Current Month's Expense Summary Graph");
        s.setSpan(new RelativeSizeSpan(1.7f), 0, 15, 0);
        s.setSpan(new StyleSpan(Typeface.NORMAL), 15, s.length() - 14, 0);
        s.setSpan(new ForegroundColorSpan(Color.GRAY), 15, s.length() - 14, 0);
        s.setSpan(new RelativeSizeSpan(.8f), 15, s.length() - 14, 0);
